// Define the translation map for Romanian language
pub fn get_ro_translations() -> phf::Map<&'static str, &'static str> {
    phf::phf_map! {
...
/// Returns the plural forms rule for Romanian language
pub fn get_ro_plural_forms() -> &'static str {
