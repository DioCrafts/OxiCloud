...
use rust_i18n::translation_map;

/// Czech (Czech Republic) translations for the Files app
pub fn get_translation() -> (HashMap<&'static str, &'static str>, &'static str) {
    let translations = translation_map! {
        ...
        "undo" => "vrátit zpět",
        "_%n folder_::_%n folders_" => "_%n složka_::_%n složky_::_%n složek_",
        "_%n file_::_%n files_" => "_%n soubor_::_%n soubory_::_%n souborů_",
        "{dirs} and {files}" => "{dirs} a {files}",
        "_Uploading %n file_::_Uploading %n files_" => "_Nahrávám %n soubor_::_Nahrávám %n soubory_::_Nahrávám %n souborů_",
